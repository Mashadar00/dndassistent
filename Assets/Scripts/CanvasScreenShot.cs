 ...
 */
    ...
    private IEnumerator _takeScreenShot(Canvas canvasPanel, SCREENSHOT_TYPE screenShotType = SCREENSHOT_TYPE.IMAGE_AND_TEXT, bool createNewInstance = true)
    {
        ...
        Texture2D screenImage = new Texture2D((int)(image.sizeDelta.x * image.localScale.x), (int)(image.sizeDelta.y * image.localScale.y));
        //Get Image from screen
        screenImage.ReadPixels(new Rect(0, 0, (int)(image.sizeDelta.x * image.localScale.x), (int)(image.sizeDelta.y * image.localScale.y)), 0, 0);
